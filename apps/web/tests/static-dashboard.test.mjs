...
const expectations = [
  ...
  ['telegram approval primary surface', page, 'Telegram decision pending'],
  ['telegram pending Korean label', page, 'Telegram에서 결정 대기 중'],
  ['approval resend secondary action', page, 'Telegram 결재카드 재전송'],
  ['approval details secondary action', page, '상세 로그 보기'],
  ['approval API secondary support', page, '/api/approval-decision'],
  ...
  ['agent factory CSS', css, 'agent-factory-board'],
